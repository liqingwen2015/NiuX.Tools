namespace System
{
    ...
    public static partial class NiuXComparableExtensions
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool IsBetween<T>(this T value, T minValue, T maxValue, bool includeMinValue, bool includeMaxValue) where T : IComparable<T>
        {
            if (value == null)
            {
            ...
            return includeMinValue && lowerCompareResult == 0 || includeMaxValue && upperCompareResult == 0 || lowerCompareResult > 0 && upperCompareResult < 0;
        }
    }
}