...
namespace System
{
    ...
    public static partial class NiuXStringExtensions
    {
        ...
        /// <returns></returns>
        public static bool IsNotNullAndNotWhiteSpace(this string str) => !str.IsNullOrWhiteSpace();
        ...
        /// <returns></returns>
        public static bool IsEqual(this string str, string value, StringComparison comparisonType = StringComparison.OrdinalIgnoreCase) => string.Equals(str, value, comparisonType);
        ...
        /// <param name="comparisonType"></param>
        /// <returns></returns>
        public static bool IsNotEqual(this string str, string value, StringComparison comparisonType = StringComparison.OrdinalIgnoreCase) => !IsEqual(str, value, comparisonType);
