...
namespace NiuX.DependencyInjection.Extensions
{
    public static partial class ServiceContainerBuilderExtensions
    {
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateSingleton<TService>(func));
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateSingleton<TService>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateSingleton<TService, TServiceImplement>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateScoped<TService>(func));
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateScoped<TService>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateScoped<TService, TServiceImplement>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateTransient<TService>(func));
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateTransient<TService>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.Add(ServiceDefinition.CreateTransient<TService, TServiceImplement>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateSingleton<TService>(func));
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateSingleton<TService>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateSingleton<TService, TServiceImplement>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateScoped<TService>(func));
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateScoped<TService>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateScoped<TService, TServiceImplement>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateTransient<TService>(func));
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateTransient<TService>());
            return serviceContainerBuilder;
        }
        ...
        {
            serviceContainerBuilder.TryAdd(ServiceDefinition.CreateTransient<TService, TServiceImplement>());
            return serviceContainerBuilder;
        }
