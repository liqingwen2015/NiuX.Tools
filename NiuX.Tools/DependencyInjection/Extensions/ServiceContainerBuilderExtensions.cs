...
namespace NiuX.DependencyInjection.Extensions
{
    public static partial class ServiceContainerBuilderExtensions
    {
        ...
        //    => RegisterAssemblyTypes(services, null, ServiceLifetime.CreateSingleton, assemblies);
        ...
        //    => RegisterAssemblyTypes(services, typesFilter, ServiceLifetime.CreateSingleton, assemblies);
        ...
        //    => RegisterAssemblyTypesAsImplementedInterfaces(services, typesFilter: null, ServiceLifetime.CreateSingleton, assemblies);
        ...
        //    => RegisterAssemblyTypesAsImplementedInterfaces(services, typesFilter: typesFilter, ServiceLifetime.CreateSingleton, assemblies);
        ...
        //    ServiceLifetime serviceLifetime = ServiceLifetime.CreateSingleton)
        ...
        ///// <param name="serviceLifetime">service lifetime</param>
        ///// <returns>services</returns>
        //public static IServiceContainerBuilder RegisterTypeAsImplementedInterfaces([NotNull] this IServiceContainerBuilder services, Type type, Func<Type, bool>? interfaceTypeFilter, ServiceLifetime serviceLifetime = ServiceLifetime.CreateSingleton)
        //{
        //    if (type != null)
        //    {
